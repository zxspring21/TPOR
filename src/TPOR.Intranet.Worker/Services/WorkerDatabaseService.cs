...
public class WorkerDatabaseService : IDatabaseService
{
    private readonly ILogger<WorkerDatabaseService> _logger;
    private readonly TporDbContext _context;

    public WorkerDatabaseService(ILogger<WorkerDatabaseService> logger, TporDbContext context)
    {
        _logger = logger;
        _context = context;
    }
